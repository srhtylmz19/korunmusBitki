...
@section('main-content')
    ...
    <div class="box box-warning">
        ...
        <div class="box-body">
            ...
            {!! Form::open(['method'=>'POST', 'enctype'=>'multipart/form-data', 'action'=>'Admin\PostController@store']) !!}
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="postContent" class="form-control" placeholder="Başlık">
                </div>
