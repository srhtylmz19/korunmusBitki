...
@section('main-content')
    ...
    <div class="box box-warning">
        ...
        {!!   Form::open(array('method'=>'POST','enctype'=>'multipart/form-data','action' => array('Admin\PortfolioCategoriesController@update',$portfolioCategory->id))) !!}
        ...
        <!-- text input -->
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="title" id="title" placeholder="Enter ..." value="{{$portfolioCategory->title}}">
            </div>
